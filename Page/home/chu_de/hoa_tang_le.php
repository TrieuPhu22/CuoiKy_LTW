...
<head>
    ...
    <title>Hoa Tang Lễ - Hoa Chia Buồn</title>
    <?php
...
<body>
    ...
    <main>
        <div class="homeContainer my-5">
            ...
            <h1 class="text-center category-title my-3">Hoa Tang Lễ - Hoa Chia Buồn</h1>
            <hr class="mb-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: { action: 'get_by_subcategory', subcategory_id: 3 },  
                dataType: 'json',
