...
<head>
    ...
    <title>Hoa Khai Trương Giá Rẻ</title>
...
<body>
    ...
    <main>
        <div class="homeContainer my-5">
            <h1 class="text-center category-title mb-3">Hoa Khai Trương Giá Rẻ</h1>
            <hr class="mb-4">
            ...
            <div class="row" id="product-grid">
                <div class="col-12">
                    <p>Không có sản phẩm giá rẻ để hiển thị (demo placeholder).</p>
                </div>
            </div>
